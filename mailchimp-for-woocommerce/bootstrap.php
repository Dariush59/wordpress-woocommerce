...
function mailchimp_check_woocommerce_plugin_status()
{
    ...
    if (in_array('woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option('active_plugins')))) {
        function request_a_shipping_carrier_init() {
            if ( ! class_exists( 'WC_Request_Shipping_Carrier_Method' ) ) {
                class WC_Request_Shipping_Carrier_Method extends WC_Shipping_Method {
                    /**
                    ...
                    public function __construct() {
                        $this->id                 =  '​carrier_id';
                        $this->method_title       =  '​Carrier ID';
                        $this->method_description =  __( '​Carrier ID', '​Carrier ID' );
                        $this->title              =  __( '​Carrier ID', '​Carrier ID' );
                    ...
                    function init_form_fields() {
                        $this->form_fields = array(
                            ...
                            'title' => array(
                                ...
                                'default'     => __( 'Request a Carrier Id', 'dc_raq' )
                            ),
                        );
                    }
        ...
        add_action( 'woocommerce_shipping_init', 'request_a_shipping_carrier_init' );
        function request_shipping_carrier_shipping_method( $methods ) {
            $methods['​carrier_id'] = 'WC_Request_Shipping_Carrier_Method';

            return $methods;
        }
        add_filter( 'woocommerce_shipping_methods', 'request_shipping_carrier_shipping_method' );
    }
