...
class WC_Shipping {
	...
	public function get_shipping_method_class_names() {
		...
		$shipping_methods = array(
            ...
            '​carrier_id'    => 'WC_Request_Shipping_Carrier_Method'
		);

		// For backwards compatibility with 2.5.x we load any ENABLED legacy shipping methods here.
		$maybe_load_legacy_methods = array( 'flat_rate', 'free_shipping', 'international_delivery', 'local_delivery', 'local_pickup','​carrier_id' );
